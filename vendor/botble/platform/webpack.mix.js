...
mix
    ...
    .copy(dist + '/media/css/media.css', source + '/media/public/media/css')
    .js(source + '/media/resources/assets/js/media.js', dist + '/media/js')
    .copy(dist + '/media/js/media.js', source + '/media/public/media/js')
    .js(source + '/media/resources/assets/js/jquery.addMedia.js', dist + '/media/js')
    .copy(dist + '/media/js/jquery.addMedia.js', source + '/media/public/media/js')
    .js(source + '/media/resources/assets/js/integrate.js', dist + '/media/js')
    .copy(dist + '/media/js/integrate.js', source + '/media/public/media/js')
