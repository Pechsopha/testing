...
add_shortcode('left-side-ads', 'Side ads', 'All side ads', function () {
    return Theme::partial('short-codes.left-side-ads');
});

add_shortcode('right-side-ads', 'Side ads', 'All side ads', function () {
    return Theme::partial('short-codes.right-side-ads');
});

add_shortcode('leaderboard-ads', 'Leaderboard ads', 'All leaderboard ads', function () {
    return Theme::partial('short-codes.leaderboard-ads');
});

add_shortcode('category-post-ads', 'Category post feature ads', 'All category post ads', function () {
    return Theme::partial('short-codes.category-post-ads');
});

add_shortcode('below-facebook-page-ads', 'Below facebook page ads', 'Below faecbook page ads', function () {
    return Theme::partial('short-codes.below-facebook-page-ads');
});

add_shortcode('home-top-ads', 'Home top ads', 'Home Top ads', function () {
    return Theme::partial('short-codes.home-top-ads');
});
