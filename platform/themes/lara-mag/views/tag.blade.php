                ...
                <ul>
                    @foreach($posts as $post_tag)
                        <section class="new-item bsize">
                            <a class="new-item-thumb thumb-full fleft item-thumbnail" href="{{ $post_tag->url }}">
                            ...
                            <section class="new-item-info">
                                ...
                                <section class="new-item-morelink">
                                    <a href="{{ $post_tag->url }}">{{ __('View more') }}<i class="fa fa-angle-right" aria-hidden="true"></i></a>
