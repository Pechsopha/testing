    ...
    {!! Form::open(['route' => ['settings.edit']]) !!}
        <div class="max-width-1200">
            ...
            <div class="flexbox-annotated-section">
                <div class="flexbox-annotated-section-annotation">
                    <div class="annotated-section-title pd-all-20">
                        <h2>{{ trans('core/setting::setting.general.footer') }}</h2>
                    </div>
                    <div class="annotated-section-description pd-all-20 p-none-t">
                        <p class="color-note">{{ trans('core/setting::setting.general.footer_description') }}</p>
                    </div>
                </div>
                ...
                <div class="flexbox-annotated-section-content">
                    <div class="wrapper-content pd-all-20">
                        ...
                        <div class="form-group">
                            <label class="text-title-field"
                                   for="footer_general">{{ trans('core/setting::setting.general.footer_general') }}
                            </label>
                            <textArea id="footer_general" style="height: 250px !important;" name="footer_general" class="next-input form-control" data-value="{{ setting('footer_general') }}"></textArea>
                        </div>
                        <div class="form-group">
                            <label class="text-title-field"
                                   for="footer_contact">{{ trans('core/setting::setting.general.footer_contact') }}
                            </label>
                            <textArea id="footer_contact" style="height: 250px !important;" name="footer_contact" class="next-input form-control" data-value="{{ setting('footer_contact') }}"></textArea>
                        </div>
                    </div>
                </div>
                ...
                <script>
                    (function() {
                        const generalFooter = document.querySelector('#footer_general');
                        const contactFooter = document.querySelector('#footer_contact');

                        const generalFooterValue = generalFooter.dataset.value;
                        const contactFooterValue = contactFooter.dataset.value;

                        generalFooter.value = generalFooterValue;
                        contactFooter.value = contactFooterValue;
                    })();
                </script>
            </div>
